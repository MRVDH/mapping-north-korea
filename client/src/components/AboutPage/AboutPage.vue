            ...
            <v-layout class="row">
                <v-flex xs12>
                    <v-card>
                        ...
                        <v-card-text>
                            The purpose of this tool is to discover North Korea by analysing sattelite imagery and mapping everything to <a
                                target="_blank"
                                href="https://www.openstreetmap.org/about"
                                >OpenStreetMap</a>. Because of a lack of interest, and probably due to it being unmonetizable, other map providers (such as Google) have only mapped North Korea to a very basic level.
                        </v-card-text>
                        ...
                        <v-card-text>
                            ...
                            The application is fully dynamic, which means it can be used for any other place on earth as well. The GitHub repository can be found <a
                        ...
                        <v-card-text>
                            ...
                            <ul>
                                <li>
                                    The application used to be hosted on a DigitalOcean droplet, but due to the amount of time I spent configuring ssl, nginx etc I decided to move to their new App Platform. However, the app platform caused a lot of problems, including a 3 day downtime in which digital ocean support could not be of any assistance. Therefore, I decided to move to <a
                                        target="_blank"
                                        href="https://render.com/"
                                        >
                                        Render
                                    </a>. The setup was easy, and now everything is automated, giving me more time to work on the actual code instead of the hosting.
                                </li>
                                <li>
                                ...
                                <li>
                                    The <a
                                        ...
                                        >
                                        MongoDB Atlas
                                    </a> platform (free tier) is used for running the <a
                                        target="_blank"
                                ...
                                <li>
                                    npm packages include <a
                                        ...
                                        target="_blank"
                                        href="https://github.com/kelektiv/node-uuid"
                                        >
                                        uuid
                                    </a>, <a
                                        target="_blank"
                                        href="https://github.com/jdesboeufs/connect-mongo"
                                        >
                                        connect-mongo
                                    </a>, <a
                                        target="_blank"
                                        href="https://github.com/Automattic/mongoose"
                                        >
                                        mongoose
                                    </a> and <a
                                        target="_blank"
                            ...
                            <ul>
                                ...
                                <li>
                                    Testing has been done in the <a
                                        target="_blank"
                                ...
                                <li>
                                    For the light map <a
                                        ...
                                        >
                                        Leaflet-providers
                                    </a> is used and for the dark map the awesome <a
                                        target="_blank"
                                        href="https://docs.stadiamaps.com/themes/#alidade-smooth-dark"
                                        >
                                        "Alidade Smooth Dark" layer
                                    </a> of <a
                                        target="_blank"
                                ...
                                <li>
                                    <a
                                        ...
                                        >
                                        axios
                                    </a> is used for sending requests to the server.
                                </li>
                                <li>
                                    To transpile and build all the front-end code <a
                                        target="_blank"
                                        ...
                                        >
                                        ESLint
                                    </a> and a ton of other packages were used.
                                </li>
                                <li>
                                    I took inspiration for the color codes of the sectors and how to get the connection strings for iD and JOSM from the <a
                                        target="_blank"
                            ...
                            <ul>
                                <li>
                                    "<i>Develop awesome webapps using VueJS + Webpack (demonstrating by building a XRP ledger integration)</i>" by Wietse Wind - <a
                                        target="_blank"
                                        href="https://itnext.io/develop-awesome-webapps-using-vuejs-webpack-bda08ebb691c"
                                        >
                                        link
                                    </a>
                                </li>
                                <li>
                                    "<i>Anyway, here’s how to make AJAX &amp; API calls with Vue JS</i>" by darkylmnx - <a
                                        target="_blank"
                                        href="https://itnext.io/anyway-heres-how-to-do-ajax-api-calls-with-vue-js-e71e57d5cf12"
                                        >
                                        link
                                    </a>
                                </li>
                                <li>
                                    "<i>A simple EventBus to communicate between Vue.js components</i>" by Andrejs Abrickis - <a
                                        target="_blank"
                                        href="https://medium.com/@andrejsabrickis/https-medium-com-andrejsabrickis-create-simple-eventbus-to-communicate-between-vue-js-components-cdc11cd59860"
                                        >
                                        link
                                    </a>
                                </li>
                                <li>
                                    And of course many many many <a
                                        target="_blank"
                        ...
                        <v-card-text>
                            You can contact me at <a href="mailto:info@maartenvandenhoven.com">info@maartenvandenhoven.com</a> for questions about this project and anything else or visit my website at <a href="https://maartenvandenhoven.com">https://maartenvandenhoven.com</a>. Alternatively I am also reachable on OpenStreetMap by the username <a
                                href="https://www.openstreetmap.org/user/Artemis64"
                                target="_blank"
                                >
                                Artmemis64
                            </a> or on GitHub <a
